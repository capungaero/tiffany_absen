        ...
        if($token_data['status'] === TRUE)
        {
            try
            {
                ...
                try {
                    ...
                    return ['status' => FALSE, 'message_item' => 'token_failed', 'message' => $e->getMessage()];
                }
                ...
                if(!empty($token_decode) AND is_object($token_decode))
                {
                    ...
                    if (empty($token_decode->API_TIME OR !is_numeric($token_decode->API_TIME))) {
                        ...
                        return ['status' => FALSE, 'message_item' => 'token_failed', 'message' => 'Token Time Not Define!'];
                    }
                    else
                    {
                        /**
                        ...
                        {
                            return ['status' => FALSE, 'message_item' => 'token_failed', 'message' => 'Token Time Expire.'];
                    ...
                    return ['status' => FALSE, 'message_item' => 'token_failed', 'message' => 'Forbidden'];
                }
            }
            catch(Exception $e) {
                return ['status' => FALSE,'message_item' => 'token_failed', 'message' => $e->getMessage()];
